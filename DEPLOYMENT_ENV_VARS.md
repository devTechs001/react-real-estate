...
| `MONGODB_URI` | MongoDB connection | [MongoDB Atlas](https://cloud.mongodb.com) | `mongodb+srv://user:pass@cluster.mongodb.net/real-estate` |
...
# Database
MONGODB_URI=mongodb+srv://user:pass@cluster.mongodb.net/real-estate
