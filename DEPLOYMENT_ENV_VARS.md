...
| `MONGODB_URI` | MongoDB connection | [MongoDB Atlas](https://cloud.mongodb.com) | `mongodb+srv://devtechs842_db_user:<password>@cluster0.kparor6.mongodb.net/omnibiz?retryWrites=true&w=majority&appName=omnibiz` |
...
# Database
MONGODB_URI=mongodb+srv://devtechs842_db_user:<your_password_here>@cluster0.kparor6.mongodb.net/omnibiz?retryWrites=true&w=majority&appName=omnibiz
...
- Verify MongoDB URI is correct (format: `mongodb+srv://devtechs842_db_user:<password>@cluster0.kparor6.mongodb.net/omnibiz?retryWrites=true&w=majority&appName=omnibiz`)
