...
const Login = () => {
  ...
  return (
    <>
      <SEO title="Login - HomeScape" description="Sign in to your HomeScape account" />
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          ...
          >
            ...
            <div className="space-y-3 mb-6">
              ...
              <button className="w-full py-3 px-4 border border-gray-200 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    } focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all pr-12`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
