...
const SellerMessages = () => {
  ...
  const fetchConversations = async () => {
    try {
      const { data } = await api.get('/seller/messages/conversations');
  ...
  return (
    <>
      <SEO title="Messages" description="Seller messages and inquiries" />
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white py-12">
        <div className="container-custom">
          ...
          <p className="text-xl">Communicate with potential buyers</p>
        </div>
      </div>
